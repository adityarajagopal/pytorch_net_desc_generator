...
__all__ = ['mnasnet', 'MNASNet', 'mnasnet0_5', 'mnasnet0_75', 'mnasnet1_0', 'mnasnet1_3']
...
class _InvertedResidual(nn.Module):
    ...
    def forward(self, input):
        if self.apply_residual:
            return self.layers(input) + self.shortcut(input)
        else:
...
def mnasnet(num_classes, pretrained): 
    return mnasnet1_0(pretrained)
